...
namespace BankingSystem
{
    public class UpdatedAccountInformationService
    {
        public UpdatedAccountInformationResponse UpdatedAccountInformation(UpdatedAccountInformationRequest updatedAccountInformationRequest)
        {
            ...
            if (AccountInformation == null) throw new ArgumentException($"Account Number {updatedAccountInformationRequest.AccountNumber}'s User Doesn't Exists.");
            ...
            if (updatedAccountInformationRequest.AddressLine != null && updatedAccountInformationRequest.AddressLine != AccountInformation.Address.AddressLine)
            {
                ...
                if (updatedAccountInformationRequest.AddressLine == null || updatedAccountInformationRequest.AddressLine.Length <= 1 || updatedAccountInformationRequest.AddressLine.Length >= 30 || (updatedAccountInformationRequest.AddressLine.Contains(' ') && !updatedAccountInformationRequest.AddressLine.Split(' ').All(w => w.All(c => Char.IsLetterOrDigit(c) || c == '_' || c == ' ' || c == '-' || c == ',' || c == '.')))) throw new ArgumentException($"Address Line: {updatedAccountInformationRequest.AddressLine} is INVALID!");
                else if (!updatedAccountInformationRequest.AddressLine.All(c => Char.IsLetterOrDigit(c) || c == '_' || c == ' ' || c == '-' || c == ',' || c == '.')) throw new ArgumentException($"Address Line: {updatedAccountInformationRequest.AddressLine} is INVALID!");
            ...
            if (updatedAccountInformationRequest.City != null && updatedAccountInformationRequest.City != AccountInformation.Address.City)
            {
                ...
                if (updatedAccountInformationRequest.City == null || updatedAccountInformationRequest.City.Length <= 2 || updatedAccountInformationRequest.City.Length >= 20 || updatedAccountInformationRequest.City.Any(char.IsDigit) || updatedAccountInformationRequest.City.Any(char.IsSymbol)) throw new ArgumentException($"Address City: {updatedAccountInformationRequest.City} is INVALID!");
                if ((updatedAccountInformationRequest.City.Contains(' ') && !updatedAccountInformationRequest.City.Split(' ').All(w => w.All(c => Char.IsLetterOrDigit(c) || c == '_' || c == ' ' || c == '-' || c == ',' || c == '.')))) throw new ArgumentException($"Address City: {updatedAccountInformationRequest.City} is INVALID!");
                else if (!updatedAccountInformationRequest.City.All(c => Char.IsLetterOrDigit(c) || c == '_' || c == ' ' || c == '-' || c == ',' || c == '.')) throw new ArgumentException($"Address City: {updatedAccountInformationRequest.City} is INVALID!");
                Address address = AccountInformation.Address;
            ...
            if (updatedAccountInformationRequest.State != null && updatedAccountInformationRequest.State != AccountInformation.Address.State)
            {
                ...
                if (updatedAccountInformationRequest.State == null || updatedAccountInformationRequest.State.Length <= 2 || updatedAccountInformationRequest.State.Length >= 28 || updatedAccountInformationRequest.State.Any(char.IsDigit) || updatedAccountInformationRequest.State.Any(char.IsSymbol)) throw new ArgumentException($"Address State: {updatedAccountInformationRequest.State} is INVALID!");
                if ((updatedAccountInformationRequest.State.Contains(' ') && !updatedAccountInformationRequest.State.Split(' ').All(w => w.All(c => Char.IsLetterOrDigit(c) || c == '_' || c == ' ' || c == '-' || c == ',' || c == '.')))) throw new ArgumentException($"Address State: {updatedAccountInformationRequest.State} is INVALID!");
                else if (!updatedAccountInformationRequest.State.All(c => Char.IsLetterOrDigit(c) || c == '_' || c == ' ' || c == '-' || c == ',' || c == '.')) throw new ArgumentException($"Address State: {updatedAccountInformationRequest.City} is INVALID!");
                Address address = AccountInformation.Address;
