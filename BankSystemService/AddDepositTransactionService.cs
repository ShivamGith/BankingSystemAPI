...
namespace BankingSystem
{
    public class AddDepositTransactionService
    {
        public AddDepositTransactionResponse AddDepositTransaction(AddDepositTransactionRequest addDepositTransactionRequest)
        {
            ...
            // General Validations 
            if (addDepositTransactionRequest.AccountNumber.Length < 10 || addDepositTransactionRequest.AccountNumber.Length > 18 || !addDepositTransactionRequest.AccountNumber.All(char.IsDigit)) throw new ArgumentException($"Account Number: {addDepositTransactionRequest.AccountNumber} is Not Valid");
